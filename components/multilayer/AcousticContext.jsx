...
export function AcousticContextProvider({ children }) {
    const [state, dispatch] = useReducer(acousticReducer, { materials: GET_DUMMY_MATERIALS() });
    ...
    return (
        <AcousticContext.Provider value={{ materials: state.materials, addMaterial, removeMaterial, updateMaterial }}>
            {children}
